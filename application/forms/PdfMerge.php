...
class Application_Form_PdfMerge extends Zend_Form
{
    function init()
    {
        ...
        $destFile->setMaxFileSize(268435456); // 256MB
        $destFile->addValidator('Extension', false, 
            array('pdf', 'messages' => 
                array(
        ...
        $srcFile->setMaxFileSize(268435456); // 256MB
        $srcFile->addValidator('Extension', false, 
            array('pdf', 'messages' => 
                array(
                    Zend_Validate_File_Extension::FALSE_EXTENSION => 'Wrong file format! Only PDF allowed.',
                    Zend_Validate_File_Extension::NOT_FOUND => 'File not found!'
